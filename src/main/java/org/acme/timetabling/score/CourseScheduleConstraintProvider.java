package org.acme.timetabling.score;
...
public class CourseScheduleConstraintProvider implements ConstraintProvider {
    ...
    Constraint minimumWorkingDays(ConstraintFactory factory) {
        return factory.forEach(Lecture.class)
                .groupBy(Lecture::getCourse, countDistinct(Lecture::getWeekDay))
    ...
    Constraint curriculumCompactness(ConstraintFactory factory) {
        return factory.forEach(Curriculum.class)
                ...
                .ifNotExists(Lecture.class,
                        equal((curriculum, lecture) -> lecture.getWeekDay(), Lecture::getWeekDay),
